...
def column_to_list(data: list, index: int) -> list:
    """
    Dado uma lista de utilização de bicicletas, retorna uma lista contendo todos os valores no índice index.
    :param list data: lista de utilização de bicicletas importada do csv, com linhas e colunas.
    :param int index: indice que sera extraido da lista
    :return: Nova lista com todos os valores na posicao index de data
    :rtype: list
    """
    column_list = []
...
def count_gender(data_list: list) -> list:
    """
    Dado uma lista de utilização de bicicletas, retorna a contagem de homens e mulheres presentes na lista.
    :param list data_list: lista de utilização de bicicletas importada do csv, com linhas e colunas.
    :return: lista com a contagem de homens e mulheres
    :rtype: list
    """
    gender_list = column_to_list(data_list, -2)
    male = reinvent_count(gender_list, 'Male')
...
def most_popular_gender(data_list: list) -> str:
    """
    Dado uma lista de utilização de bicicletas, retorna qual gênero mais frequente.
    :param list data_list: lista de utilização de bicicletas importada do csv, com linhas e colunas.
    :return: 'Male', 'Female' or 'Equal'
    :rtype: str
    """
...
answer = "Porque há linhas (samples) sem a informação do gênero do usuário."
...
def count_items(column_list: list) -> tuple:
    """
    Dado uma lista, retorna uma tupla com seus valores unicos e o número de vezes que eles ocorrem na lista.
    :param list column_list: lista que será contabilizada.
    :return: itens_unicos, contagem_de_cada_item_unico
    :rtype: tuple
    """
